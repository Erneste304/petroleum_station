    ...
    <div class="col-md-6">
        <div class="card h-100 border-0 shadow-sm overflow-hidden" style="border-radius: 15px;">
            ...
            <div class="card-body p-4 text-center">
                ...
                <form method="POST">
                    <button type="submit" name="buy_shares" class="btn btn-warning px-5 rounded-pill fw-bold">
                        Invest Now
                    </button>
                </form>
            </div>
    ...
    <div class="col-md-6">
        <div class="card h-100 border-0 shadow-sm overflow-hidden" style="border-radius: 15px;">
            ...
            <div class="card-body p-4 text-center">
                ...
                <a href="#" class="btn btn-primary px-5 rounded-pill fw-bold">Browse Catalog</a>
            </div>
        </div>
    </div>
</div>
